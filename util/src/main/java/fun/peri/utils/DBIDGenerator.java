...
public class DBIDGenerator implements java.io.Serializable {
     ...
     */
    private static final int DEFAULT_INCREMENT_BY = 5;
     ...
     * Exception that complicates the use becase a static instance
     ...
     */
    private long read() throws Exception {
     ...
     */
    private void initQueries() throws Exception {
        Connection conn = null;
        try {
    ...
    public static void close(Connection con, PreparedStatement ps, ResultSet rs) {
        if (rs != null) {
            try {
                ...
                log.error("DBTools close ResultSet error!", e);
            }
        }
