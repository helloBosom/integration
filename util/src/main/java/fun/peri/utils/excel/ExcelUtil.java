...
public class ExcelUtil {
    ...
    public static final int WORD_BOOK_BUFF_SIZE = 1000;
    ...
    public static void exportExcel(String title, Map<String, String> headMap,
                                   JSONArray jsonArray, String datePattern,
...
//        comment.setAuthor("JACK");
    ...
    public static void exportExcelX(String title, Map<String, String> headMap, JSONArray jsonArray, String datePattern, int colWidth, OutputStream out) {
        ...
        // 声明一个工作薄
        try {
            SXSSFWorkbook workbook = new SXSSFWorkbook(WORD_BOOK_BUFF_SIZE);//缓存
...
//        cellStyle.setFillPattern(HSSFCellStyle.SOLID_FOREGROUND);
    ...
    //Web 导出excel
    public static void downloadExcelFile(String title, Map<String, String> headMap, String fileName,
        ...
        try {
            ...
            response.setHeader("Content-Disposition", "attachment;filename=" + fileName);// new String((title + ".xlsx").getBytes(), "iso-8859-1"));
    ...
    public static void main(String[] args) throws IOException {
        ...
        outXls.close();*/
        //
        OutputStream outXlsx = new FileOutputStream("D://c.xlsx");
        System.out.println("正在导出xlsx....");
        Date d2 = new Date();
        ExcelUtil.exportExcelX(title, headMap, ja, null, 0, outXlsx);
        System.out.println("执行" + (new Date().getTime() - d2.getTime()) + "ms");
        outXlsx.close();
