...
public class ESQueryBuilders implements ESCriterion {
	 ...
	 *            集合值
	 */
	public ESQueryBuilders terms(String field, ESCriterion.Operator values) {
	 ...
	 * @return
	 */
	public ESQueryBuilders gt(String field, Object from) {
		list.add(new ESSimpleExpression(field, from, Operator.GT).toBuilder());
		return this;
	}
	 ...
	 * @return
	 */
	public ESQueryBuilders lt(String field, Object to) {
		list.add(new ESSimpleExpression(field, to, Operator.LT).toBuilder());
		return this;
	}
